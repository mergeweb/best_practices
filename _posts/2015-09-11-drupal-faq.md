...
{% endhighlight %}
(see [here](https://www.drupal.org/node/171213) for more info)
...
To get content that you have entered in the backend to appear, put this in your page.tpl.php: <?= render($page['content']); ?>
For any other template, you can use <?= render($content); ?>
